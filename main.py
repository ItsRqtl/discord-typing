...
async def invite(ctx):print(ctx.author.roles);await ctx.send("Invite Typing to your server!",components=Button(style=ButtonStyle.LINK,label="Click me!",url="https://discord.com/api/oauth2/authorize?client_id=991618813856591942&permissions=67111936&scope=applications.commands%20bot"),ephemeral=True)
client.start()